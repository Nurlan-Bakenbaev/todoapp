...
function App() {
  ...
  const style = {
    ...
    container: `bg-[#e0e0e0] max-w-[600px] w-full m-auto rounded-md shadow-xl p-5`,
    ...
    alert:
      "text-center p-3 text-[red] text-xl border border-solid border-red-500 flex items-center ",
  };
  return (
    <div className={style.bg}>
      <div className={style.container}>
        ...
        <div className={style.alert}>{alert ?
          <p style={{width:'50%'}}>Enter a valid todo</p>:''}</div>
