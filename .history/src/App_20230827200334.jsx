...
function App() {
  ...
  useEffect(() => {
    ...
    const unsubscribe = onSnapshot(q, (querySnapshot) => { // Changed parameter name to querySnapshot
      let todosArr = []; // Changed variable name to todosArr
      querySnapshot.forEach((doc) => { // Changed querySnapshotforEach to querySnapshot.forEach
