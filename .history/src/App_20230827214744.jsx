...
function App() {
  ...
  const style = {
    ...
    alert:
      "p-3 text-[red] text-xl border border-solid border-red-500 flex items-center ",
  };
  return (
    <div className={style.bg}>
      <div className={style.container}>
        ...
        <form onSubmit={createTodos} className={style.form}>
          ...
          />
          <button onClick={cre} className={style.button}>
            <AddIcon />
          </button>
        </form>
        ...
        {alert ? "" : <p className={style.alert}>Enter a valid todo</p>}
