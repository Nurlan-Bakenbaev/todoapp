...
function App() {
  ...
  const style = {
    bg: ` p-4 bg-gradient-to-r from-[#ff45e6] to-[#ff7445]`,
  ...
  return (
    <div className={style.bg}>
      <div className={style.container}>
        ...
        <p
          className={`${
            isAlert ? "animate-bounce" : "hidden"
          } text-red-500 text-xl border border-solid border-red-500 flex items-center p-3`}
        >
          Enter a valid todo
        </p>
