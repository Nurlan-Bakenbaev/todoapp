...
function App() {
  ...
  const style = {
    ...
    container: `bg-[#e0e0e0] max-w-[600px] w-full m-auto rounded-md shadow-xl p-6 flex flex-col items-center`,
    ...
    alert:
      "text-center p-3 text-[red] text-xl border border-solid border-red-500 w-[50%] text-center",
  };
  return (
    <div className={style.bg}>
      <div className={style.container}>
        ...
        <p className={style.alert}>Enter a valid todo</p>
